...
def test_get_recomb_of_two_reps_without_mutation(recombination_process: RecombinationProcess) -> None:
    """Tests the recombination of two representations without mutation."""
    first_rep: Tuple[int, ...] = (1, 3, 5)
    second_rep: Tuple[int, ...] = (2, 4, 6)

    desc_rep: Tuple[int, ...] = recombination_process.get_a_mutation_from_the_reps(first_rep, second_rep)
